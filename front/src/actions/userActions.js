...
export const loadUser=()=> async(dispatch) =>{
    try{
        ...
        const {data} = await axios.get("/api/myPerfil")
        dispatch({
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.put('/api/myPerfil/updateDatos', userData, config)
...
export const updatePassword = (passwords) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.put('/api/myPerfil/updatePassword', passwords, config)
