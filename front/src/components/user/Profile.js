                ...
                <Fragment>
                    ...
                    <div className="row justify-content-around mt-5 user-info">
                        <div className="col-12 col-md-3">
                            ...
                            <Link to="/myPerfil/updateDatos" id="edit_profile" className="btn btn-primary btn-block my-5">
                                Editar Perfil
                            </Link>
                        </div>
                        ...
                        <div className="col-12 col-md-5">
                            ...
                            <Link to="/myPerfil/updatePassword" className="btn btn-primary btn-block mt-3">
                                Cambiar contraseña
                            </Link>
                        </div>
                    </div>
